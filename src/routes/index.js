...
//geting the IP address of the four server which will get from the four different server
const hostnameToIP = {
...
// route where you can download the file 
...
// IP validation of the from where the file is downloaded
